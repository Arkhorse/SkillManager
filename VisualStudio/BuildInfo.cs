namespace SkillManager
{
    public static class BuildInfo
    {
        ...
        public const string Name                            = "SkillManager";
        ...
        public const string GUIName                         = "Skill Manager";
